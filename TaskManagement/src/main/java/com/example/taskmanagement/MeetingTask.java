...
public class MeetingTask implements Task {
    ...
    public MeetingTask(String taskName, String description, Priority priority, boolean completed, Date deadline) {
    ...
    public String toString() {
        ...
        return "Meeting Task: " + getTaskName() + " - " + getDescription() + " (Priority: " + getPriority() +
