...
public class HomeworkTask implements Task {
    ...
    public HomeworkTask(String taskName, String description, Priority priority, boolean completed, Date deadline) {
    ...
    public String toString() {
        ...
        return "Homework Task: " + getTaskName() + " - " + getDescription() + " (Priority: " + getPriority() +
